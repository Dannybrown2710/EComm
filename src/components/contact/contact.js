...
export default class Contact extends Component {
  render() {
    return (
      <div className="mt-5">
        <img src={require('../../images/contact.png')} class="img-responsive imagebg" alt="logo" /><br />
        <Grid className="bg text-center mt-7">
          <Row>
            <Col md={12} xs={8}>
          ...
          <Row className="mt-10 pb-2">
            <Col md={4}>
              <img src={require('../../images/maps.png')} alt="logo" /><br />
              <p>
            ...
            <Col md={4}>
              <img src={require('../../images/phone.png')} alt="logo" /><br />
              <p>Office: <b>9916232160</b></p>
            </Col>
            <Col md={4}>
              <img src={require('../../images/mail.png')} alt="logo" /><br />
